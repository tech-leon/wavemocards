...
export const EmoFormStep5: React.FC = () => {
  ...
  const handleIntensityChange = (cardID: number, intensity: number) => {
    ...
    const updatedIntensity = {
      ...emoFormData.finalIntensity,
      [cardID]: intensity,
    };
    updateEmoFormData({ finalIntensity: updatedIntensity });
  };
            ...
            >
              {[1, 2, 3, 4, 5].map((intensity) => (
                <Button
                  ...
                  size="iconLg"
                  variant={
                    emoFormData.finalIntensity[card.ID] === intensity
                      ? "numberCircleActive"
                      : "numberCircle"
                  }
