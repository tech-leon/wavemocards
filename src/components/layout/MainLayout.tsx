...
export async function MainLayout({ children, locale, user }: MainLayoutProps) {
  ...
  return (
    <div className="grid min-h-dvh grid-rows-[auto_minmax(0,1fr)_auto] grid-cols-[minmax(0,1fr)] bg-background">
      <a
        href="#main-content"
      ...
      <main id="main-content" className="min-h-0 flex flex-col min-h-[calc(100dvh-68px)] lg:min-h-[calc(100dvh-77px)] bg-background overflow-x-clip" role="main">
        {children}
      </main>
