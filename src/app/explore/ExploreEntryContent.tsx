      ...
      <div className="container mx-auto py-4 pt-8" id="top">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <FadeIn className="md:w-2/3 mb-6 md:mb-0" delay={0.1}>
            <div className="h-full px-5 sm:px-9 py-4 sm:py-6 bg-main-tint03 rounded-lg text-sm text-gray-700 flex flex-col justify-center gap-1 md:gap-3">
              <p>你在情緒的世界裡迷航了嗎？</p>
              <p>沒關係，讓我們一起在浪潮情緒卡中，探索自己的情緒。</p>
              <p>
                邀請你先閉上眼睛，<span className="text-main font-bold">深呼吸</span>，再慢慢地吐氣。
              </p>
              <p>
                在吸氣與吐氣的過程，
                <span className="text-main font-bold">慢慢地感受自己的身體與心靈的狀態</span>。
              </p>
              <p>
                如果準備好了的話，
          ...
          {/* Mobile start button */}
          <FadeIn className="md:hidden mt-2 flex justify-center w-full" delay={0.4}>
            <button
              type="button"
              onClick={handleStart}
          ...
          {/* Illustration */}
          <FadeIn className="md:w-1/3 pt-9 flex flex-col items-center" delay={0.3}>
            <Image
          ...
          <FadeIn className="hidden md:flex mt-6 justify-center w-full" delay={0.5}>
            <button
              type="button"
              onClick={handleStart}
        ...
        {/* Illustration credit */}
        <div className="mt-4 mb-16 md:mt-16 md:mb-2 flex justify-center text-gray-500 text-[10px]">
          Illustration by{' '}
          <a
