...
export default function ExploreStoryActionPage() {
  ...
  return (
    ...
    >
      {/* Instructions */}
      <ul className="ml-1 mt-3 mb-6 text-muted-foreground text-sm space-y-1">
        <li>謝謝你，努力地回想了情緒發生的背景、原因。</li>
        <li>接下來，想邀請你一起回想在情緒浪潮來臨之後⋯⋯</li>
        <li className="text-muted-foreground text-xs">若您暫時不想紀錄，可以跳過此步驟，直接點擊「下一步」</li>
      </ul>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg">
            <label htmlFor="storyAction" className="block py-3 px-4">
              <p className="mb-1 text-muted-foreground text-xs">第 1 題</p>
            ...
            <textarea
              ...
              className="w-full mb-3 p-3 border rounded border-border text-foreground min-h-[100px] resize-y"
            />
          </div>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          ...
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg order-2">
            <label htmlFor="storyResult" className="block py-3 px-4">
              <p className="mb-1 text-muted-foreground text-xs">第 2 題</p>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg">
            <label htmlFor="storyFeeling" className="block py-3 px-4">
              <p className="mb-1 text-muted-foreground text-xs">第 3 題</p>
              <p className="text-main font-medium">
                對於上述發生的結果，你有什麼樣的感受呢？
              </p>
            </label>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          ...
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg order-2">
            <label className="block py-3 px-4">
              <p className="mb-1 text-muted-foreground text-xs">第 4 題</p>
              <p className="text-main font-medium">
                你覺得這個的結果是否是你所期待的結果呢？
              </p>
            </label>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    storyExpect === option.value
                      ...
                      : 'border-muted-foreground/50 text-muted-foreground hover:border-main-tint01 hover:text-main-tint01'
                  )}
                >
                  {option.label}
                </button>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg">
            <label htmlFor="betterAction" className="block py-3 px-4">
              <p className="mb-1 text-muted-foreground text-xs">第 5 題</p>
      ...
      {/* Credit */}
      <div className="hidden md:block text-right text-muted-foreground text-[10px] mb-16">
        Illustration by{' '}
        <a className="text-muted-foreground" href="https://icons8.com/illustrations/author/iAdLsFJOKDrk" target="_blank" rel="noopener noreferrer">
          Tanya Krasutska
        </a>{' '}
        from{' '}
        <a className="text-muted-foreground" href="https://icons8.com/illustrations" target="_blank" rel="noopener noreferrer">
          Ouch!
        </a>
      </div>
    </ExploreStepLayout>
