...
export default function ExploreStoryActionPage() {
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg">
            <label htmlFor="storyAction" className="block py-3 px-4">
              <p className="mb-1 text-gray-550 text-xs">第 1 題</p>
            ...
            <textarea
              ...
              className="w-full mb-3 p-3 border rounded border-gray-500 text-gray-900 min-h-[100px] resize-y"
            />
          </div>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          ...
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg order-2">
            <label htmlFor="storyResult" className="block py-3 px-4">
              <p className="mb-1 text-gray-550 text-xs">第 2 題</p>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg">
            <label htmlFor="storyFeeling" className="block py-3 px-4">
              <p className="mb-1 text-gray-550 text-xs">第 3 題</p>
              <p className="text-main font-medium">
                對於上述發生的結果，你有什麼樣的感受呢？
              </p>
            </label>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          ...
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg order-2">
            <label className="block py-3 px-4">
              <p className="mb-1 text-gray-550 text-xs">第 4 題</p>
              <p className="text-main font-medium">
                你覺得這個的結果是否是你所期待的結果呢？
              </p>
            </label>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    storyExpect === option.value
                      ...
                      : 'border-gray-400 text-gray-600 hover:border-main-tint01 hover:text-main-tint01'
                  )}
                >
                  {option.label}
                </button>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-6">
          <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg">
            <label htmlFor="betterAction" className="block py-3 px-4">
              <p className="mb-1 text-gray-550 text-xs">第 5 題</p>
      ...
      {/* Credit */}
      <div className="hidden md:block text-right text-gray-500 text-[10px] mb-16">
        Illustration by{' '}
