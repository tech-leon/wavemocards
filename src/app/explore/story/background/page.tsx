...
export default function ExploreStoryBackgroundPage() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-stretch gap-6 mb-16">
        <div className="md:w-2/3 lg:w-3/4 bg-main-tint03 rounded-lg">
          ...
          <textarea
            ...
            className="w-full mb-3 mx-0 p-3 border rounded border-border text-foreground min-h-[120px] resize-y"
      ...
      {/* Credit */}
      <div className="text-right text-muted-foreground text-[10px] mb-16">
        Illustration by{' '}
